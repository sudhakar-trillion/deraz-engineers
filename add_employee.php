<?php include("includes/header.php"); 
		...
		if(isset($_POST['submit']))
		{
			...
			// inserting the employees details into employees table
		   mysql_query("insert into employees (`employeeId`, `roll`, `firstName`, `fatherName`, `dob`, `bloodGroup`, `userName`, `password`, `email`, `officialEmail`, `gender`, `designation`, `dateJoining`, `emergencyContact`, `emergencyName`, `emergencyRelation`, `personalMobile`, `cHno`, `cStreet`, `cLandmark`, `cCity`, `cArea`, `cPincode`, `pHno`, `pStreet`, `pLandmark`, `pCity`, `pArea`, `pPincode`,  `status`, `dateTime`,`branch`,`role`) values ('". $employeeId ."', '". $_POST['roll'] ."', '". $_POST['firstName'] ."', '". $_POST['fatherName'] ."', '". $dob ."', '". $_POST['bloodGroup'] ."', '". $_POST['username2'] ."', '". $_POST['password3'] ."', '". $_POST['email'] ."', '". $_POST['officialEmail'] ."', '". $_POST['gender'] ."', '". $_POST['designation'] ."', '". $doj ."', '". $_POST['emergencyContact'] ."', '". $_POST['emergencyName'] ."', '". $_POST['relation'] ."', '". $_POST['mobile'] ."', '". $_POST['c_hno'] ."', '". $_POST['c_street'] ."', '". $_POST['c_landmark'] ."', '". $_POST['c_city'] ."', '". $_POST['c_area'] ."', '". $_POST['c_pincode'] ."', '". $_POST['p_hno'] ."', '". $_POST['p_street'] ."', '". $_POST['p_landmark'] ."', '". $_POST['p_city'] ."', '". $_POST['p_area'] ."', '". $_POST['p_pincode'] ."', '1', NOW(), '". $_POST['branch'] ."','" . $_POST['type']. "')");			
		    ...
		    // mail sending code after registration 
...
{ echo '<div class="alert alert-danger"><button class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button>Error occured, please try again.</div>'; }
                                    ...
                                    <form class="form-horizontal row-border" id="validation-form1" action="" method="post" enctype="multipart/form-data" autocomplete="off">
                                   ...
                                   <div class="form-group">
                                        ...
                                        <label for="fatherName" class="col-md-2 control-label">Father's Name</label>
                                        <div class="col-md-4"> 
                                         <div class="clearfix">
										...
										<div class="col-md-4">
                                         <div class="clearfix">
											<label class="radio-inline" for="male">
												<input type="radio" class="uniform" name="gender" id="male" value="Male" required>
												Male
											</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                        <div class="clearfix">
											<input type="text" name="emergencyName" id="emergencyName" class="form-control required" >
										</div>
                                        </div>
