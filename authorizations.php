<?php include("includes/sa_header.php"); 
  ...
  if(isset($_GET['did']))
  {
	 ...
	 header("location: authorizations.php?delete=success");
  }
	...
	if(strcmp($dailyNotification['reportType'],'daily')==0)
										 {
											 ...
											 $dateMonth = $reportDate; 
											  $url = 'sa_add_daily_report.php?aid='.$dailyNotification['autoId'];
										 }
										 ...
										 {  
											 ...
											 $url = 'sa_add_actionplan.php?aid='.$dailyNotification['autoId'];
										 }
	  ...
	  else if(strcmp($dailyNotification['authorization'],'No')==0)
	  {
		 ?> <span class="label label-sm label-danger">Pending</span> <?php
                              	...
                              	<button class="btn btn-danger btn-sm" title="delete" onclick="confirmDelete('<?php echo $dailyNotification['autoId'] ?>')">
                                      ...
                                      <?php if($dailyNotification['status']==0) { ?> <a href="<?php echo $url; ?>" class="btn btn-default btn-sm">
...
<![endif]-->
  ...
  function confirmDelete(did)
  {
	  ...
	  {
	  window.location = 'authorizations.php?did='+did;
	  }
  }
