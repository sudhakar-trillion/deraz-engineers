...
relation between branches and employees are employees.branch = branches.branchId and get the data based on leadStatus = Pending Invoice in daily_reports
*/
...
where daily_reports.offer > '0' and daily_reports.po > '0' and daily_reports.leadStatus = 'Pending Invoice'
...
left join customers on daily_reports.company = customers.customerId
left join employees on daily_reports.addedBy = employees.id
$where where daily_reports.leadStatus = 'Pending Invoice'
 order by reportId desc");							
...
$list[] = $rowlist;
 ...
 unset($rowlist);
  ...
  ?><tr><td colspan="3"></td><td><?php echo $finalTotal; ?></td><td colspan="5"></td></tr><?php
