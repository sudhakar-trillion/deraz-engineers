...
where daily_reports.leadStatus = 'Offer to be generated' and daily_reports.offer > '0' GROUP BY reportId desc");
...
where daily_reports.reportId = '". $_GET['repId'] ."' and daily_reports.leadStatus = 'Offer to be generated' and daily_reports.offer > '0' GROUP BY reportId desc");
