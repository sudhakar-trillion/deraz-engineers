...
// add employee Target into targets
...
//	}
  ...
  if($lastId>0)
  {
	// header("location: employees.php?targetset=1");  
  }
}
...
*/
 ...
 $numRecords = mysql_query("select employees.id, employees.firstName, employees.email, employees.dateJoining, employees.emergencyContact, employees.emergencyName, employees.emergencyName, employees.personalMobile, rolls.roll, branches.branch from employees 
...
//employeewise and branchwise search options  where daily_reports.po = '0'
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							<li class="active"> <i class="ace-icon fa fa-home home-icon"></i> Weekly Sales Reports </li>
...
{  echo '<div class="alert alert-info"><button class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button>Financial year target has been set..</div>'; }
  ...
  <?php  // to download file in excel format we have written this code.
     $list[] = array('S. No', 'Name', 'Designation', 'Email', 'Mobile', 'Date' ); 
	 $sno = 1;
	 
//if( 0 < mysql_num_rows($employees))
    ...
    while($employee = mysql_fetch_array($employees))
  {
	...
	// we will get the product price from product_price table  
...
$price = mysql_fetch_array($prices);
	 ...
	 ?><tr>
														...
														<td>
															<!--<a href="weekly_sales_report.php?eid=<?php echo $employee['id']; ?>"><?php echo ucfirst($employee['firstName']); ?></a>--><?php echo ucfirst($employee['firstName']); ?>
														</td>
                                                        <td>
                                  ...
                                  <!--          <a class="btn btn-success btn-sm" href="view_employee.php?eid=<?php echo $employee['id'] ?>">
                                            ...
                                            <a href="weekly_sales_report.php?eid=<?php echo $employee['id']; ?>" class="btn btn-success btn-sm">
                                            <i class="ace-icon fa fa-eye"></i>
                                            </a>
...
<![endif]-->
  ...
  function confirmDelete(did)
  {
	  ...
	  {
	  window.location = 'weekly_sales_reports.php?did='+did;
	  }
  }
  
  function goToPage(pid)
{
   window.location = 'weekly_sales_reports.php?page='+pid;	
}
