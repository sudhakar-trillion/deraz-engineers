<?php include("includes/sa_header.php"); 
		...
		{
$expectedDate = explode('-',$_POST['expectedDate']);           
$expectedDate = $expectedDate[2].'-'.$expectedDate[1].'-'.$expectedDate[0];

		  
mysql_query("insert into expected_sales (`customerId`, `product`, `quantity`, `expectedValue`, `expectedDate`, `dateTime`, `employeeId`) values ('". $_POST['customerId'] ."', '". $_POST['product'] ."', '". $_POST['quantity'] ."', '". $_POST['expectedValue'] ."', '". $expectedDate."',  NOW(), '". $_SESSION['id'] ."')");			
			
			$lastId = mysql_insert_id();
			
			if($lastId>0)
			{
			  header("location: sa_add_sales_projection.php?add=1");	
			}
			else
			{
			  header("location: sa_add_sales_projection.php?error=1");	
			}
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							<li>
								...
								<a href="sa_projections.php">Projections</a>
							</li>

							<li class="active">Add Sales Projection</li>
						</ul><!-- /.breadcrumb -->
								...
								<div class="row">
									<div class="col-xs-6">
										...
										<div>
                                           ...
                                           <?php
	   if(isset($_GET['add']))
{ $alertMsg = '<div class="alert alert-info"><button class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button>Sales Projection Data has been added!</div>'; }
  ...
  if(isset($alertMsg)) { echo $alertMsg; }
	   ...
	   ?> 
                                    ...
                                    <div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="expectedDate"> Expected Date </label>

										<div class="col-sm-9">
											<input type="text" id="expectedDate" name="expectedDate" placeholder="Expected Date" class="form-control date-picker" />
										</div>
									</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<select id="company" name="customerId" class="col-xs-10 col-sm-12" >
						...
						<input type="text" id="product" name="product" placeholder="product" class="col-xs-10 col-sm-12" />
                              ...
                              <div class="form-group">
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="expectedValue" name="expectedValue" placeholder="expectedValue" class="col-xs-10 col-sm-12" />
										</div>
									</div>
 ...
 <script>
		...
		function getInvoiceList(val)
		{
			...
			document.getElementById("invoiceList").style.display = 'block';
				$.ajax({url: "ajax/getProjectionInvoiceDetails.php?val="+val, success: function(result){
		...
		function getInvoiceDetails(id,val,rvid)
		{
		    ...
		    $.ajax({url: "ajax/getProjectionInvoiceData.php?reportId="+id+"&rvid="+rvid, success: function(result){
		          $("#div1").html(result);
            }});	
		}
