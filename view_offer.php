<?php  include("includes/header.php"); 
     ...
     //if status is pending invoice then we generate Invoice number
...
where daily_reports.reportId = '". $_GET['pid'] ."'");
 ...
 // get the daily report products from daily_reports_data table.
 $items = mysql_query("select categories.category, brands.brand, products.productId,product_model.ModelNo, products.product, products.code, daily_reports_data.id, daily_reports_data.price, daily_reports_data.quantity,  daily_reports_data.amount, daily_reports_data.taxSystem, daily_reports_data.taxPercentage, daily_reports_data.taxAmount from daily_reports_data 
