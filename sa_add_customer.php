<?php include("includes/sa_header.php"); 
		...
		if(isset($_POST['submit']))
		{
		   ...
		   mysql_query("insert into customers (`customerNumber`, `company`, `department`, `location`, `contactPerson`, `designation`, `email`, `phone`, `contactPerson1`, `designation1`, `email1`, `phone1`, `address`, `status`, `dateTime`, `addedBy`) values ('". $customerNumber ."', '". $_POST['company'] ."', '". $_POST['department'] ."', '". $_POST['location'] ."', '". $_POST['contactPerson'] ."', '". $_POST['designation'] ."', '". $_POST['email'] ."', '". $_POST['phone'] ."', '". $_POST['contactPerson1'] ."', '". $_POST['designation1'] ."', '". $_POST['email1'] ."', '". $_POST['phone1'] ."', '". addslashes($_POST['address']) ."', '1', NOW(), '". $_SESSION['id'] ."')");			
			...
			if($lastId>0)
			{
			  header("location: sa_add_customer.php?add=1");	
			}
			else
			{
			  header("location: sa_add_customer.php?error=1");	
			}
...
{ $msg = '<div class="alert alert-danger"><button class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button>Error occured, please try again.</div>'; }
  ...
  if(isset($msg)) { echo $msg; }
                                 ...
                                 <form class="form-horizontal" role="form" action="" method="post" autocomplete="off" id="validation-form">
                                    ...
                                    <div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="location"> Address </label>

										<div class="col-sm-9">
											<input type="text" id="location" name="location" placeholder="Address" class="col-xs-10 col-sm-12"  />
										</div>
									</div>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="contactPerson1"> Alternate Contact Person </label>

										<div class="col-sm-9">
											<input type="text" id="contactPerson1" name="contactPerson1" placeholder="Alternate Contact Person" class="col-xs-10 col-sm-12"  />
										</div>
									</div>
