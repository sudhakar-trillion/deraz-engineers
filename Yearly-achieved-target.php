			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							<li class="active"> <i class="ace-icon fa fa-home home-icon"></i> Yearly achieved targets </li>
						</ul><!-- /.breadcrumb -->
                        
<a href="excel/Yearly-achieved-target.csv" title="Download"><span class="badge badge-success"><i class="ace-icon fa fa-cloud-download bigger-110 icon-only"></i></span></a>
...
?>
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<?php echo date('Y').' achieved target by '.ucwords($employee); ?>
	...
	if(mysql_num_rows($qry)>0)
	{
		...
		while($data=mysql_fetch_object($qry))
		{
            ...
            <tr><td colspan=6> </td> <td> <strong>Total</strong></td><td><b><?PHP echo $totalAmnt; ?> </b></tr>
               ...
               <?php                              
$fp = fopen('excel/Yearly-achieved-target.csv', 'w');
