...
$salesAchieved = mysql_query("select inv.total as Achieved, emp.firstName from invoices as inv left join daily_reports as dr on inv.reportId=dr.reportId left join employees as emp on dr.addedBy=emp.id where dr.addedBy=".$employee['id']); 
