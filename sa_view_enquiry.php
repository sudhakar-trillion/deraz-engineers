...
//  data comes from daily_reports,enquiry_products,enquiries,enquiry_assign table
$enquiries = mysql_query("select e.name, ep.quantity,  e.enquiryNumber, daily_reports.leadStatus, c.category, b.brand, ea.dateandtime, e.enqDate, e.company, e.email, e.source, e.phone, p.product, p.code, ea.assignedTo  from enquiry_products as ep join  enquiry_assign as ea on ep.eaId=ea.eaId 
...
join enquiries as e on e.enquiryId=ea.enquiryId
left join daily_reports on e.enquiryNumber = daily_reports.enquiryNumber

 where e.enquiryId=".$_GET['eid']." order by ep.eaId desc");
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							<li>
								...
								<a href="sa_enquiries.php">Enquiries</a>
							</li>
