...
// get the data based on leadStatus = Pending Proforma Invoice in daily_reports
...
relation between branches and employees are employees.branch = branches.branchId and get the data based on leadStatus = Pending Proforma Invoice in daily_reports
*/

$numRecords = mysql_query("select daily_reports.reportId, daily_reports.enquiryNumber, daily_reports.reportDate, daily_reports.leadType, daily_reports.leadStatus, daily_reports.poNo, daily_reports.poDateTime, daily_reports.inv, daily_reports.invoice, daily_reports.leadStatus, daily_reports.runcard, daily_reports.invoiceDateTime, customers.company, employees.firstName from daily_reports
...
where daily_reports.offer > '0' and daily_reports.po > '0' and daily_reports.leadStatus = 'Pending Proforma Invoice'
...
// get the data based on leadStatus = Pending Proforma Invoice in daily_reports
					$proposals = mysql_query("select daily_reports.reportId, daily_reports.offer, daily_reports.enquiryNumber, daily_reports.offerNo, daily_reports.offerToBeSubmitted,  daily_reports.currentRevisionId, daily_reports.reportDate, daily_reports.leadType, daily_reports.leadStatus, invoices.invoiceStatus, daily_reports.po, daily_reports.poNo, daily_reports.poDateTime, daily_reports.inv, daily_reports.invoice, daily_reports.runcard, daily_reports.invoiceDateTime, daily_reports.proformaInvoice, daily_reports.proformaInvoiceDateTime, customers.company, employees.firstName from daily_reports
 left join invoices on daily_reports.reportId = invoices.reportId
left join customers on daily_reports.company = customers.customerId
left join employees on daily_reports.addedBy = employees.id
$where where daily_reports.leadStatus = 'Pending Proforma Invoice'
 order by reportId desc");							
									...
									// get the data based on leadStatus = Pending Proforma Invoice in daily_reports
											...
											$proposals = mysql_query("select daily_reports.reportId, daily_reports.enquiryNumber, daily_reports.offer, daily_reports.offerNo, daily_reports.offerToBeSubmitted,  daily_reports.currentRevisionId, daily_reports.reportDate, daily_reports.leadType, daily_reports.leadStatus, daily_reports.po, daily_reports.poNo, daily_reports.poDateTime, daily_reports.runcard, daily_reports.inv, daily_reports.invoice, daily_reports.invoiceDateTime, daily_reports.proformaInvoice, daily_reports.proformaInvoiceDateTime, customers.company, employees.firstName from daily_reports
 left join invoices on daily_reports.reportId = invoices.reportId
left join customers on daily_reports.company = customers.customerId
left join employees on daily_reports.addedBy = employees.id
where daily_reports.offer > '0' and daily_reports.po > '0' and daily_reports.leadStatus = 'Pending Proforma Invoice'
...
{ $alertMsg = '<div class="alert alert-danger"><button class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button>Error occured, please try again.</div>'; }
  ...
  // to download file in excel format we have written this code.
      $list[] = array('S. No', 'Report Date', 'Offer No', 'Po No', 'Po Date', 'Value', 'Executive', 'Company', 'Status' );
													 ...
													 <?php if($proposal['enquiryNumber']!='')
													 {
													  ...
													  ?>
                                                        ...
                                                        <td>
                                                         ...
                                                         <td>
															<?php echo ucfirst($proposal['runcard']); ?>
														</td>
...
$list[] = $rowlist;
 ...
 unset($rowlist);
  ...
  ?><tr><td colspan="4"></td><td><?php echo $finalTotal; ?></td><td colspan="6"></td></tr><?php
