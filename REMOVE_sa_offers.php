...
$result = mysql_query("select offers.offerId, offers.offerDate, offers.contactPerson, offers.designation, offers.phone, offers.email, offers.clientStatus, offers.leadType, offers.leadStatus, offers.futureDate, offers.remarks, offers.poNo, offers.poValue, offers.poDateTime, offers.paymentType, offers.addedOn, customers.company  from offers 
                          left join customers on offers.company = customers.customerId
						  where offers.addedBy = '". $_SESSION['id'] ."'
						  order by offers.offerId desc limit $start, $limit");
...
$price = mysql_fetch_array($prices);*/
	 ...
	 ?><tr>
														<td class="center">
                                                         ...
                                                         <td>
															<?php $date = explode('-',$row['offerDate']);
