...
/*  $result = mysql_query("select products.product, products.code, daily_reports_data.id, daily_reports_data.quantity 
 from invoices
...
order by daily_reports_data.reportId desc");
	 ...
	 ?><tr>
														...
														<?php  echo $i; ?>
															...
															if($a==1 || $invId!=$proposal['invoiceId'])
															{															
															$invId = $proposal['invoiceId']; 
															$a=2;
															$display=1;
                                                         ...
                                                         <td>
															...
															{
															echo $proposal['poNo'].'  ';
													     $invoiceDate = explode(' ',$proposal['poDateTime']); 
													...
													echo $invoiceDate;
                                                        ...
                                                        <td>
                                                             ...
                                                             <?php
															  ...
															  echo $proposal['grandTotal'];
															 $finalTotal = $finalTotal+$proposal['grandTotal']; 
															 $diff = $proposal['grandTotal']-$collectedAmount; 
...
$rowlist[] = $diff;
 ...
 $i++;
  ...
  } ?><tr><td colspan="6"></td><td><?php echo $finalTotal; ?></td></tr> <?php } else {
