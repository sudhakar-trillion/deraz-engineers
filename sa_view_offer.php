...
$result = mysql_query("select daily_reports.reportId, daily_reports.currentRevisionId, daily_reports.enquiryNumber, daily_reports.offerNo, daily_reports.toWhom, daily_reports.reasonChange, daily_reports.contactPerson, daily_reports.designation, daily_reports.phone, daily_reports.email, daily_reports.clientStatus, daily_reports.leadType, daily_reports.leadStatus, daily_reports.futureDate, daily_reports.remarks, daily_reports.poNo, daily_reports.poValue, daily_reports.paymentType, daily_reports.addedOn, daily_reports.total, customers.company  from daily_reports 
 ...
 $revision = mysql_query("select revisionId, subTotal, discount, duty, dutyPercentage, pf, pfPercentage, total, grandTotal , revisionDateTime  from daily_reports_revision where reportId = '". $row['reportId'] ."' and revision = '". $row['currentRevisionId'] ."'");
...
{ $alertMsg = '<div class="alert alert-danger"><button class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button>Error occured, please try again.</div>'; }
  ...
  if(isset($alertMsg)) { echo $alertMsg; }
 									...
 									<tr><td> Enquiry No. </td><td><?php if($row['enquiryNumber']!='')
													 {
                                           ...
                                           <tr><td> Lead Status </td><td><?php echo $row['leadStatus'];
                                                   ...
                                                   <td>
                                                    ...
                                                    <td><?php echo $row['reasonChange']; ?></td>
												</tr>
