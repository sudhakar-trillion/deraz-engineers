<?php include("includes/sa_header.php"); 
 ...
 $numRecords = mysql_query("select actionplans.visitDate, actionplans.purposeVisit, actionplans.expectedValue, actionplans.remarks, customers.company, customers.location from actionplans 
left join customers on actionplans.customerId = customers.customerId
where actionplans.month = '". $cm ."' and employeeId = '". $_SESSION['id'] ."'
order by actionplans.planId desc");
...
$plans = mysql_query("select actionplans.visitDate, actionplans.purposeVisit, actionplans.expectedValue, actionplans.remarks, customers.company, customers.location from actionplans 
left join customers on actionplans.customerId = customers.customerId
where actionplans.month = '". $cm ."' and employeeId = '". $_SESSION['id'] ."'
order by actionplans.planId desc limit $start, $limit");
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							<li class="active"> <i class="ace-icon fa fa-home home-icon"></i> Action Plans </li>
						</ul><!-- /.breadcrumb -->
...
$price = mysql_fetch_array($prices);*/
	 ...
	 ?><tr>
                                                        ...
                                                        <td>
															<?php 
															      $date = explode('-',$plan['visitDate']);
																  echo $date[2].'-'.$date[1].'-'.$date[0];
																       ?>
														</td>
														<td>
															<?php echo $plan['company']; ?>
														</td>
                                                        <td>
															<?php echo ucfirst($plan['location']); ?>
														</td>
                                                        <td>
															<?php echo $plan['purposeVisit']; ?>
														</td>
                                                        <td>
															<?php echo $plan['expectedValue']; ?>
														</td>
                                                        <td>
															<?php echo $plan['remarks']; ?>
														</td>
...
<?php
 $i++; } } else { ?> <tr><td colspan="8"> No Data found. </td></tr> <?php }
...
{
   window.location = 'sa_actionplans.php?page='+pid;	
}
		
		function changeMonth(cm)
		{
			window.location = 'sa_actionplans.php?cm='+cm;
		}
