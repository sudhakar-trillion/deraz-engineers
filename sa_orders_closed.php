			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							<li class="active"> <i class="ace-icon fa fa-home home-icon"></i>Closed Orders   </li>
						</ul><!-- /.breadcrumb -->
...
{ $alertMsg = '<div class="alert alert-danger"><button class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button>Error occured, please try again.</div>'; }
  ...
  <?php 
     $list[] = array('S. No', 'Offer', 'Po No', 'Proforma Date', 'Proforma', 'Invoice Date', 'Invoice', 'Grand Total', 'Company', 'Person', 'Phone', 'Status');
...
<?php 
 ...
 else
 {
  ...
  <?php } ?>      
                                            ...
                                            <?php                              
$fp = fopen('excel/sa_orders_closed.csv', 'w');
