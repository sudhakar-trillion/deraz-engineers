...
mysql_query("insert into services_station (`serialNumber`, `date`, `customerName`, `product`, `category`, `modelNo`, `equipmentNo`, `quantity`, `complaint`, `addedBy`, `engineer`) 
values ('$serialNumber', '$date', '$customerName', '$product', '$categoryId', '$modelNo', '$equipmentNo', '$quantity', '$natureComplaint', '". $_SESSION['id'] ."', '$engineer')");
...
$lastId = mysql_insert_id();
 ...
 if($lastId>0)
 {
	  ...
	  mysql_query("insert into service__station_status (`serviceId`, `status`, `updatedOn`) values ('$lastId', 'open', NOW())");   
	  header("location: add_station_service.php?add=1");	
}		
			else
			{
			  header("location: add_station_service.php?error=1");	
			}
           ...
           <ul class="typeahead dropdown-menu" style="left: 10px; display: none;" id="categoryList">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
										...
										<div class="col-sm-9">
                                         <div class="clearfix">
											<input type="text" id="equipmentNo" name="equipmentNo" placeholder="Equipment No" class="col-xs-10 col-sm-12"  />
                                            </div>
										</div>
									</div>
