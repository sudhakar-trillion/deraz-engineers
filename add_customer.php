<?php include("includes/header.php"); 
		...
		if(isset($_POST['submit']))
		{
			...
			// inserting the customer into customers table
		   mysql_query("insert into customers (`customerNumber`, `company`,`department`, `location`, `contactPerson`, `designation`, `email`, `phone`, `contactPerson1`, `designation1`, `email1`, `phone1`, `address`, `status`, `dateTime`, `addedBy`) values ('". $customerNumber ."', '". $_POST['company'] ."','". $_POST['department'] ."', '". $_POST['location'] ."', '". $_POST['contactPerson'] ."', '". $_POST['designation'] ."', '". $_POST['email'] ."', '". $_POST['phone'] ."', '". $_POST['contactPerson1'] ."', '". $_POST['designation1'] ."', '". $_POST['email1'] ."', '". $_POST['phone1'] ."', '". addslashes($_POST['address']) ."', '1', NOW(), '". $_SESSION['id'] ."')");			
			
			$lastId = mysql_insert_id();
			
			if($lastId>0)
			{
			  header("location: add_customer.php?add=1");	
			}
			else
			{
								...
								<div class="row">
									<div class="col-xs-6">
										...
										<div>
                                           ...
                                           <?php
	   if(isset($_GET['add']))
{ echo '<div class="alert alert-info"><button class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button>Customer has been added!</div>'; }
...
{ echo '<div class="alert alert-danger"><button class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button>Error occured, please try again.</div>'; }
									...
									<!-- #section:elements.form -->
									 <div class="form-group">
										...
										<div class="col-sm-9">
                                        <div class="clearfix">
											<input type="text" id="company" name="company" placeholder="Company" class="col-xs-10 col-sm-12"  />
                                            </div>
										</div>
									</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="department" name="department" placeholder="Department" class="col-xs-10 col-sm-12"  />
										</div>
									</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
                                        <div class="clearfix">
											<input type="text" id="location" name="location" placeholder="Location" class="col-xs-10 col-sm-12"  />
										</div></div>
									</div>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
										...
										<div class="col-sm-9"><div class="clearfix">
											<input type="text" id="contactPerson1" name="contactPerson1" placeholder="Contact Person" class="col-xs-10 col-sm-12"  />
										</div></div>
									</div>
                                     ...
                                     <div class="form-group">
										...
										<div class="col-sm-9"><div class="clearfix">
											<input type="text" id="designation1" name="designation1" placeholder="Designation" class="col-xs-10 col-sm-12"  />
										</div></div>
									</div>
                                     ...
                                     <div class="form-group">
										...
										<div class="col-sm-9"><div class="clearfix">
											<input type="text" id="email1" name="email1" placeholder="Email" class="col-xs-10 col-sm-12"  />
										</div></div>
									</div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9"><div class="clearfix">
											<input type="text" id="phone1" name="phone1" placeholder="Phone" class="col-xs-10 col-sm-12"  />
										</div></div>
									</div>
