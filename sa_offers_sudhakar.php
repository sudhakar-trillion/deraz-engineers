...
$result = mysql_query("select daily_reports.reportId, daily_reports.offerNo, daily_reports.offerToBeSubmitted, daily_reports.enquiryNumber, date_format(enquiries.dateTime,'%d-%m-%Y') enqDate, daily_reports.currentRevisionId, daily_reports.reportDate, daily_reports.contactPerson,  daily_reports.phone, daily_reports.clientStatus, daily_reports.leadType, daily_reports.leadStatus, daily_reports.futureDate, daily_reports.remarks, daily_reports.po, daily_reports.poNo, daily_reports.reportType, customers.company  from daily_reports 
                          left join customers on daily_reports.company = customers.customerId
  						  left join enquiries on daily_reports.enquiryNumber = enquiries.enquiryNumber
						  $where 
						  order by daily_reports.reportId desc");
...
$result = mysql_query("select daily_reports.reportId, daily_reports.offerNo, daily_reports.offerToBeSubmitted, daily_reports.currentRevisionId, daily_reports.enquiryNumber, daily_reports.reportDate, daily_reports.contactPerson,  daily_reports.phone, daily_reports.clientStatus, date_format(enquiries.dateTime,'%d-%m-%Y') enqDate, daily_reports.leadType, daily_reports.leadStatus, daily_reports.futureDate, daily_reports.remarks, daily_reports.po, daily_reports.poNo, daily_reports.reportType, customers.company  from daily_reports 
                          left join customers on daily_reports.company = customers.customerId
  						  left join enquiries on daily_reports.enquiryNumber = enquiries.enquiryNumber
						  $where 
...
<p style="line-height:10px;"><div style="background:#7BACE4; width:10px; height:10px; float:left; margin-right:10px;"></div> colored are BDT</p>
  ...
  function getCustomer(val)
		{
			...
			document.getElementById("customersList").style.display = 'block';
				$.ajax({url: "ajax/getExeCustomerList.php?val="+val, success: function(result){
