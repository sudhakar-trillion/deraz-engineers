<?php ob_start(); session_start();  include("includes/db.php");
 ...
 // check user is logged in or not   
  ...
  // by clicking on forgot password we will send the mail in that we will be having random generated password
...
$message = 'Hi <br />
            <a href="http://trillionit.in/deraz/retrieve_pasword.php?code='.$code.'">Click here</a> to retrieve your password. <br /><br />
			regards<br />
			Deraz Team';
...
mysql_query("update employees set ip = '". $_SERVER['REMOTE_ADDR'] ."',remember = ''  where userName = '". $_POST['userName'] ."' and password = '". $_POST['password'] ."'");
...
text-align: center;letter-spacing: 0.5px; border-bottom-color: #fff; color:#4a4a4a; margin-top:10px; margin-bottom:5px; color:#666 !important;">
												<i class="ace-icon fa fa-coffee green" style="color:#666 !important;"></i>
		  	...
		  	<input type="password" class="form-control" placeholder="Password" name="password" id="password" value="<?php echo $password; ?>" />
													...
													<div class="clearfix">
														<label class="inline" style="font-size:13px;">
			<input type="checkbox" class="ace" name="remember" value="1" <?php if($checked==1) { ?> checked <?php } ?> />
										...
										<div class="toolbar clearfix">
											<div>
												<a href="#" data-target="#forgot-box" class="forgot-password-link" style=" color:#024c9e !important;">
										...
										<div class="widget-main">
											...
											<form action="" method="post">
												<fieldset>
													...
													<div class="clearfix">
														<button type="submit" style=" background-color:#055dc0 !important;border-color: #055dc0;" name="forgotPassword" class="width-35 pull-right btn btn-sm btn-danger">
...
<span class="green bolder"> ERP </span>--><img src="assets/images/smarterp.png" style="width:90px;" /> by <a href="http://www.trillionit.com/" target="_blank">Trillion IT</a> © 2017
						</span>
