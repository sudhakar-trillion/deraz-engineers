...
if(isset($_GET['tmid']) && $_GET['tmid']>0)
{
	...
	// data comes from enquiries table
...
// order lost
$ordersLost = mysql_query("select count(reportId) orderLost from daily_reports where daily_reports.addedBy = '".$_SESSION['id']."' and leadStatus='Order Lost'");
...
// expected collection data comes from expected_collections table
...
// achieved collection from collections table
...
// order projection from expected_sales     
...
// collections data from collections table										
$collectedAmount = mysql_query("select collections.amount from collections      
