<?php include("includes/header.php"); 
  ...
  {
	  //  adding name of category into categories table.
  ...
  if(isset($_GET['did']))
  {
	 mysql_query("delete from categories where id = '". $_GET['did'] ."'");  
				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
                         ...
                         <a href="excel/categories.csv" title="Download"><span class="badge badge-success"><i class="ace-icon fa fa-cloud-download bigger-110 icon-only"></i></span></a>
...
<a class="btn btn-primary btn-sm" href="manage_category.php?cid=<?php echo $category['id'] ?>">
<i class="ace-icon fa fa-edit icon-only"></i>
</a>

<button class="btn btn-danger btn-sm" title="delete" onclick="confirmDelete('<?php echo $category['id'] ?>')">
...
$i++; 
 ...
 <?php   $fp = fopen('excel/categories.csv', 'w');
                                            ...
                                            <div class="modal-body">
                                                  ...
                                                  <div class="form-group">
                                                         ...
                                                         <div class="form-group">
															...
															<div>
																<button class="btn btn-sm btn-primary" type="submit" name="addCategory">
...
<![endif]-->
  ...
  function confirmDelete(did)
  {
	  ...
	  {
	  window.location = 'categories.php?did='+did;
	  }
  }
